...
class BuildPublicContacts extends StatefulWidget {
  @override
  _BuildPublicContacts createState() => _BuildPublicContacts();
}

class _BuildPublicContacts extends State<BuildPublicContacts> {
  ContactUsData contactUsData = ContactUsData();

  @override
  void initState() {
    contactUsData.contactUsPublic(context, 1, "");
    contactUsData.contactUsPublicPagingController
        .addPageRequestListener((pageKey) {
      contactUsData.contactUsPublic(context, pageKey, "");
    });
        ...
        Container(
          ...
          child: Padding(
              ...
              child: Container(
                ...
                child: TextFormField(
                  onChanged: (value) {
                    contactUsData.contactUsPublic(context, 1, value);
                    contactUsData.contactUsPublicPagingController
                        .addPageRequestListener((pageKey) {
                      contactUsData.contactUsPublic(
